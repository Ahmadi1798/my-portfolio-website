...
const Navbar = () => {
  ...
  return (
    <header
      className="relative z-20 my-5 mb-10 w-full border-b border-slate-200 bg-transparent shadow-lg shadow-slate-700/5 after:absolute after:left-0 after:top-full after:z-10 after:block after:h-px after:w-full after:bg-slate-200 lg:border-slate-200 lg:backdrop-blur-sm lg:after:hidden"
      id="navbar"
    >
